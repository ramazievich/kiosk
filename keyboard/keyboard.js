...
(function() {
  ...
  this.VKI_i18n = {
    ...
    '01': "Отображение интерфейса виртуальной клавиатуры",
...
*/
  ...
  /* ****************************************************************
   * Прикрепите клавиатуру к элементу
   *
   */
  VKI_attach = function(elem) {
    ...
    if (self.VKI_imageURI) {
      ...
      keybut.className = "kiosk_search-input";
  ...
  /* ***** Найдите тегированные элементы input и textarea / Find tagged input & textarea elements ***************** */
  function VKI_buildKeyboardInputs() {
    var inputElems = [
      document.getElementsByTagName('input'),
      document.getElementsByTagName('search')
    ];
    for (var x = 0, elem; elem = inputElems[x++];)
      for (var y = 0, ex; ex = elem[y++];)
        if (ex.nodeName == "search" || ex.type == "search" || ex.type == "search")
          if (ex.className.indexOf("kiosk_search-input") > -1) VKI_attach(ex);
  ...
  /* ****************************************************************
   * Общие действия при событиях мыши / Common mouse event actions
   *
   */
  ...
  /* ***** Создайте интерфейс клавиатуры / Build the keyboard interface ************************** */
  ...
  if (this.VKI_showVersion) {
    ...
    //vr.appendChild(document.createTextNode("©️" + this.VKI_version)); //показ версии
  ...
  /* ****************************************************************
   * Вставить текст под курсором / Insert text at the cursor
   *
   */
  ...
  /* ****************************************************************
   * Показать интерфейс клавиатуры / Show the keyboard interface
   *
   */
  ...
  /* ****************************************************************
   * Расположение клавиатуры / Position the keyboard
   *
   */
